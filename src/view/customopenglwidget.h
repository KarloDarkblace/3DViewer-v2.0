...
class CustomOpenGLWidget : public QOpenGLWidget, protected QOpenGLFunctions {
 ...
 public:
  ...
  s21::ObjectController& getController();
  s21::Vector3 getObjectTranslate();
  s21::Vector3 getObjectRotation();
 ...
 private:
  ...
  s21::Vector3 object_translate_;
  s21::Vector3 object_rotation_;
};
